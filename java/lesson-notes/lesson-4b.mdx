...
:::tip Practice
-  What do you think the program will be printing if we change `true` to `false` in `line 3`?

<RadioListAns checkList={["it prints 'Is True'", "it prints 'Is False'"]} answer={2} >
</RadioListAns>
